...
-Preparation and matching of behavioural observations with accelerometry data (script 1)

-Feature extraction and data preparation for behavioural classification (script 2 and 3)

-Random Forest model using LOIO cross-validation (script 4)

-Filtering of model predictions (script 5)

-Prediction filtering and final voting on test animals (script 6)

We also present model results, observed behaviour and baseline accelerometry data.
